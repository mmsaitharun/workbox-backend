...
public class ManageTasksRequestDto {
	...
	public ManageTasksRequestDto(String owner, String taskStatus, String processName, Integer startDayFrom,
			Integer startDayTo, Integer page, String requestId, String labelValue) {
		super();
		this.owner = owner;
	...
	public String toString() {
		return "ManageTasksRequestDto [owner=" + owner + ", taskStatus=" + taskStatus + ", processName=" + processName
				+ ", startDayFrom=" + startDayFrom + ", startDayTo=" + startDayTo + ", page=" + page + ", requestId="
				+ requestId + ", labelValue=" + labelValue + "]";
	}
